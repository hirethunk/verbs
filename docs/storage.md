By default, [Events](/docs/reference/events) and [States](/docs/reference/states) are stored in your
...
[default serializer context](https://symfony.com/doc/current/components/serializer.html#context), table names, and your database connection there as well.
